...
const dict: Dictionary = {
  ...
  toolPage: {
    ...
    home: 'Inicio',
    allTools: 'Todas las herramientas',
    privacyBadge: 'Procesado 100 % en tu navegador: tu archivo nunca sale de tu dispositivo.',
    privacyProofLink: 'Cómo lo demostramos',
  ...
  privacyProofPage: {
    title: 'Prueba de privacidad: arquitectura sin subida',
    subtitle: 'Todas las herramientas de Toollora procesan tus archivos en tu navegador. Compruébalo tú mismo en menos de 30 segundos.',
    metaDescription:
      'Compruébalo tú mismo: todas las herramientas de Toollora procesan archivos 100 % en el lado del cliente, en tu navegador. Sigue la comprobación de la pestaña Red de las DevTools para confirmar que ningún archivo sale de tu dispositivo.',
    verifyTitle: 'Compruébalo tú mismo (30 segundos)',
    verifyIntro: 'Puedes confirmar que ningún archivo sale jamás de tu dispositivo con las herramientas de desarrollo integradas de tu navegador:',
    verifySteps: [
      'Abre la página de cualquier herramienta, por ejemplo el Fusionador de PDF.',
      'Abre las herramientas de desarrollo: pulsa F12, o Ctrl+Mayús+I en Windows o Cmd+Opción+I en Mac.',
      'Haz clic en la pestaña «Red» y déjala abierta mientras trabajas.',
      'Arrastra un archivo a la herramienta y procésalo exactamente como lo harías normalmente.',
      'Observa la lista de solicitudes mientras trabajas. Verás cargarse recursos locales (scripts, estilos, fuentes), pero nunca verás el nombre, el tamaño ni el contenido de tu archivo en ninguna solicitud. No existe ningún punto de subida que reciba tus datos.',
    ],
    howTitle: 'Cómo funciona la arquitectura sin subida',
    howBody: [
      'Todo el procesamiento de archivos usa API nativas del navegador que se ejecutan en tu dispositivo: la API Canvas 2D para edición de imágenes, pdf-lib y pdf.js para PDF, Tesseract.js y MediaPipe WebAssembly para OCR y segmentación IA, y la API Web Crypto para hash.',
      'Cuando seleccionas un archivo, el navegador lo lee en memoria localmente como un objeto File. Todo lo que ocurre después — compresión, conversión, fusión, renderizado, reconocimiento — sucede en JavaScript que se ejecuta en tu propia CPU. El resultado se muestra en pantalla o se descarga como un blob creado en tu navegador.',
      'Algunas herramientas descargan su motor de procesamiento en el primer uso, como el modelo de idioma del OCR o el modelo de segmentación IA, desde una red de distribución de contenido pública. Es código descargado a tu dispositivo para procesar — nunca es tu archivo, y nunca sube tus datos.',
    ],
    guaranteesTitle: 'Lo que garantizamos',
    guarantees: [
      { title: 'Sin subidas', desc: 'Ningún servidor de Toollora recibe jamás el contenido de tus archivos. No existe almacenamiento en el servidor para archivos subidos.' },
      { title: 'Sin cuentas ni seguimiento de archivos', desc: 'Todas las herramientas funcionan sin cuenta. No registramos, almacenamos ni identificamos tus archivos.' },
      { title: 'Sin límites ni anuncios', desc: 'Sin cuotas diarias y sin anuncios alrededor de tu trabajo: el procesamiento local es gratuito e ilimitado.' },
      { title: 'Verificable, no solo afirmado', desc: 'Puedes confirmar la afirmación tú mismo en la pestaña Red: no hace falta confianza ciega.' },
    ],
    ctaTitle: 'Empieza con una prueba privada',
  ...
  toolUi: {
    ...
    tools: {
      ...
      imageGenerator: {
        ...
        promptPlaceholder: 'ej.: un bosque mágico con setas brillantes, iluminación cinematográfica, muy detallado',
        negativePrompt: 'Descripción negativa',
        negativePlaceholder: 'ej.: borroso, baja calidad, texto, marca de agua',
        seed: 'Semilla',
        random: 'Aleatorio',
      ...
      storyVideoGenerator: {
        topic: 'Tema',
        topicPlaceholder: 'ej.: una aventura mágica en el bosque para niños',
        mood: 'Estilo',
        moodStory: 'Historia',
        moodEducational: 'Educativo',
        moodInspirational: 'Inspirador',
        moodAdventure: 'Aventura',
        language: 'Idioma del narrador',
        sceneCount: 'Número de escenas',
        generateScript: 'Generar guion',
        generatingScript: 'Escribiendo el guion…',
        scriptError: 'No se pudo generar el guion. Inténtalo de nuevo.',
        advanced: 'Opciones avanzadas',
        aspectRatio: 'Relación de aspecto',
        quality: 'Resolución',
        sceneDuration: 'Segundos por escena',
        durationAuto: 'Automático (según el narrador)',
        model: 'Modelo de imágenes',
        captions: 'Subtítulos',
        ...
        removeScene: 'Eliminar',
        regenerate: 'Regenerar guion',
        narrationPlaceholder: 'Texto que leerá el narrador para esta escena…',
        imagePromptPlaceholder: 'Describe la imagen que debe crear la IA para esta escena…',
        createVideo: 'Crear vídeo',
        preparing: 'Preparando imágenes y narración…',
        recording: 'Grabando tu vídeo…',
        generatingScene: 'Generando imagen {cur} de {total}…',
        loadingNarration: 'Creando narración {cur} de {total}…',
        sceneOf: 'Escena {cur} de {total}',
        stop: 'Detener',
        download: 'Descargar vídeo',
        startOver: 'Empezar de nuevo',
        preview: 'Vista previa del vídeo',
      },
  ...
  toolsContent: {
    ...
    'image-generator': {
      ...
      longDescription: 'Describe lo que quieres ver y nuestra IA convierte tus palabras en una imagen. Con tecnología de un motor de texto a imagen gratuito, sin cuenta ni registro.',
      ...
      seoDescription: 'Genera imágenes con IA a partir de una descripción de texto gratis y descárgalas con un clic. Sin inicio de sesión.',
      content: 'Escribe una descripción de la escena, el sujeto, el estilo o el ambiente que quieras y pulsa Generar. Nuestra IA produce una imagen única en segundos. El resultado aparece en la página y se descarga directamente.',
      howToSteps: [
      ...
      faq: [
        {
          question: '¿El generador de imágenes es realmente gratis?',
          answer: 'Sí. Cada generación es gratuita y no requiere cuenta, inicio de sesión ni tarjeta de crédito.',
        },
        {
          question: '¿Puedo controlar lo que crea la IA?',
          answer: 'Sí. Escribe una descripción detallada y precisa: cuanto más específica sea, más se acercará el resultado a lo que imaginas.',
        },
        {
          question: '¿Las imágenes generadas son seguras de usar?',
          answer: 'Las imágenes generadas son salidas originales del modelo de IA. Revisa el resultado antes de usarlo con fines comerciales, ya que las políticas de generación con IA varían según la plataforma.',
        },
      ],
    },
    'story-video-generator': {
      name: 'Generador de videos con historia IA',
      description: 'Convierte cualquier tema en un video narrado con imágenes IA, subtítulos y música.',
      longDescription: 'Escribe un tema y nuestra IA redacta un guion completo con descripciones de imágenes, genera las imágenes, añade un narrador que lee la historia, subtítulos, animación suave y música de fondo, y ensambla todo en un video listo para descargar. Ideal para shorts, explicaciones y publicaciones en redes sociales.',
      keywords: ['generador de video IA', 'video a partir de imágenes', 'texto a video', 'video con historia IA', 'video narrado'],
      seoTitle: 'Generador de videos con historia IA — Creador de video narrado gratis',
      seoDescription: 'Convierte un tema en un video narrado con IA gratis. Guion, imágenes, subtítulos, narración y música en un clic. Sin cuenta.',
      content: 'El Generador de videos con historia IA convierte un solo tema en un video corto completo. Gemini escribe un guion escena a escena, un modelo de imágenes pinta cada escena, un narrador lee la historia en voz alta, y la herramienta añade subtítulos, una suave animación de zoom y desplazamiento, y música de ambiente. El resultado se ensambla en tu navegador y se descarga como archivo de video listo para compartir.',
      howToSteps: [
        'Escribe un tema y elige estilo, idioma y número de escenas.',
        'Pulsa « Generar guion » y edita cualquier escena si lo deseas.',
        'Pulsa « Crear video » — la IA genera las imágenes y la narración y luego graba el video final.',
        'Previsualiza y descarga el video terminado.',
      ],
      faq: [
        {
          question: '¿Cuánto tarda en crearse un video?',
          answer: 'Generar las imágenes suele llevar más tiempo (unos segundos por escena con el modelo rápido). Grabar el video toma aproximadamente la duración del video final.',
        },
        {
          question: '¿De verdad es una IA la que narra?',
          answer: 'Sí. El video incluye un narrador de texto a voz que lee cada escena en el idioma que elijas. También puedes desactivar la narración en las opciones avanzadas.',
        },
      ],
      badge: 'Nuevo',
    },
