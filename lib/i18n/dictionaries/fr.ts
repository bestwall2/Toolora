...
const dict: Dictionary = {
  ...
  toolUi: {
    ...
    tools: {
      ...
      imageGenerator: {
        ...
        promptPlaceholder: 'ex. : une forêt magique aux champignons lumineux, éclairage cinématographique, très détaillé',
        negativePrompt: 'Description négative',
        negativePlaceholder: 'ex. : flou, basse qualité, texte, filigrane',
        seed: 'Graine (seed)',
        random: 'Aléatoire',
      ...
      storyVideoGenerator: {
        topic: 'Sujet',
        topicPlaceholder: 'ex. : une aventure magique en forêt pour enfants',
        mood: 'Ambiance',
        moodStory: 'Histoire',
        moodEducational: 'Éducatif',
        moodInspirational: 'Inspirant',
        moodAdventure: 'Aventure',
        language: 'Langue du narrateur',
        sceneCount: 'Nombre de scènes',
        generateScript: 'Générer le script',
        generatingScript: 'Écriture du script…',
        scriptError: 'Impossible de générer le script. Réessayez.',
        advanced: 'Options avancées',
        aspectRatio: 'Format d\'image',
        quality: 'Résolution',
        sceneDuration: 'Secondes par scène',
        durationAuto: 'Auto (selon le narrateur)',
        model: 'Modèle d\'images',
        ...
        removeScene: 'Retirer',
        regenerate: 'Régénérer le script',
        narrationPlaceholder: 'Texte lu par le narrateur pour cette scène…',
        imagePromptPlaceholder: 'Décrivez l\'image à générer pour cette scène…',
        createVideo: 'Créer la vidéo',
        preparing: 'Préparation des images et de la narration…',
        recording: 'Enregistrement de votre vidéo…',
        generatingScene: 'Génération de l\'image {cur}/{total}…',
        loadingNarration: 'Création de la narration {cur}/{total}…',
        sceneOf: 'Scène {cur} sur {total}',
        stop: 'Arrêter',
  ...
  toolsContent: {
    ...
    'image-generator': {
      ...
      longDescription: 'Décrivez ce que vous voulez voir et notre IA transforme vos mots en image. Propulsé par un moteur texte-vers-image gratuit, sans compte ni inscription.',
      ...
      seoDescription: 'Générez des images IA à partir d’une description texte gratuitement et téléchargez-les en un clic. Sans connexion.',
      content: 'Rédigez une description de la scène, du sujet, du style ou de l’ambiance souhaités, puis cliquez sur Générer. Notre IA produit une image unique en quelques secondes. Le résultat s’affiche dans la page et se télécharge directement.',
      howToSteps: [
      ...
      faq: [
        {
          question: 'Le générateur d’images est-il vraiment gratuit ?',
          answer: 'Oui. Chaque génération est gratuite et ne requiert ni compte, ni connexion, ni carte bancaire.',
        },
        {
          question: 'Puis-je contrôler ce que crée l’IA ?',
          answer: 'Oui. Rédigez une description détaillée et précise — plus elle est spécifique, plus le résultat correspond à ce que vous imaginez.',
        },
        {
          question: 'Les images générées sont-elles sûres à utiliser ?',
          answer: 'Les images générées sont des sorties originales du modèle d’IA. Vérifiez le résultat avant un usage commercial, car les politiques de génération par IA varient selon les plateformes.',
        },
      ],
    },
    'story-video-generator': {
      name: 'Générateur de vidéo d’histoire IA',
      description: 'Transformez n’importe quel sujet en vidéo narrée avec images IA, sous-titres et musique.',
      longDescription: 'Tapez un sujet et notre IA écrit un script complet avec des descriptions d’images, génère les images, ajoute un narrateur qui lit l’histoire, des sous-titres, une animation douce et une musique de fond, puis assemble le tout en une vidéo prête à télécharger. Parfait pour les shorts, explications et publications social.',
      keywords: ['générateur vidéo IA', 'vidéo à partir d’images', 'texte en vidéo', 'vidéo d’histoire IA', 'vidéo narrée'],
      seoTitle: 'Générateur de vidéo d’histoire IA — Créateur de vidéo narrée gratuit',
      seoDescription: 'Transformez un sujet en vidéo narrée IA gratuitement. Script, images, sous-titres, narration et musique en un clic. Sans compte.',
      content: 'Le Générateur de vidéo d’histoire IA transforme un simple sujet en vidéo courte complète. Gemini écrit un script scène par scène, un modèle d’images peint chaque scène, un narrateur lit l’histoire à voix haute, et l’outil ajoute des sous-titres, une animation douce de zoom et déplacement ainsi qu’une musique d’ambiance. Le résultat est assemblé dans votre navigateur et se télécharge comme fichier vidéo partageable.',
      howToSteps: [
        'Tapez un sujet et choisissez l’ambiance, la langue et le nombre de scènes.',
        'Cliquez sur « Générer le script » et modifiez les scènes si besoin.',
        'Cliquez sur « Créer la vidéo » — l’IA génère les images et la narration puis enregistre la vidéo finale.',
        'Prévisualisez et téléchargez la vidéo.',
      ],
      faq: [
        {
          question: 'Combien de temps faut-il pour créer une vidéo ?',
          answer: 'La génération des images est l’étape la plus longue (quelques secondes par scène avec le modèle rapide). L’enregistrement prend environ la durée de la vidéo finale.',
        },
        {
          question: 'Le narrateur est-il vraiment une IA ?',
          answer: 'Oui. La vidéo inclut un narrateur text-to-speech qui lit chaque scène dans la langue choisie. Vous pouvez aussi désactiver la narration dans les options avancées.',
        },
      ],
      badge: 'Nouveau',
    },
